...
doc = SimpleDocTemplate('GraficosLinux.pdf', pagesize=A4)
story = []
estilo = getSampleStyleSheet()


gatos_dir='/home/datos/Escritorio/Trabajo/garfield/'
contenido=os.listdir(gatos_dir)
os.system('rm -r /home/datos/Escritorio/Trabajo/garfield_Procesado/')
os.mkdir('/home/datos/Escritorio/Trabajo/garfield_Procesado/')
tim_to_gray=[]
tim_to_hist=[]
imgs=[]
for fichero in contenido:
	if os.path.isfile(os.path.join(gatos_dir,fichero)) and fichero.endswith('.jpg'):
		...
		nombre=str(fichero)
		t0=time.time()
		os.system('convert /home/datos/Escritorio/Trabajo/garfield/'+nombre+' -colorspace gray /home/datos/Escritorio/Trabajo/garfield_Procesado/F'+nombre)
		t1=time.time()
...
for fichero in contenido:
        if os.path.isfile(os.path.join(gatos_dir,fichero)) and fichero.endswith('.jpg'):
                ...
                nombre=str(fichero)
                t00=time.time()
                os.system('convert /home/datos/Escritorio/Trabajo/garfield/'+nombre+' HISTOGRAM:-')
                t11=time.time()
                val=(t11-t00)
